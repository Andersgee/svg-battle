      ...
      <main className="container mx-auto flex min-h-screen justify-center p-4">
        <div>
          ...
          <div className="mt-4 gap-12 md:flex">
            <div>
              <h2 className=" text-center text-lg text-neutral-700 dark:text-neutral-300">created battles</h2>
              <table className="">
                <tbody>
            ...
            <div>
              <h2 className="text-center text-lg text-neutral-700 dark:text-neutral-300">submissions</h2>
              <table className="">
                <tbody>
                  {user.targetSubmissions.map((submission) => (
                    <tr key={submission.targetId} className="">
                      <td className="">
                        <Link
                          className="mr-2 flex items-center py-2"
                          href={`/b/${hashidFromNumber(submission.targetId)}`}
                        >
                          <SvgImg
